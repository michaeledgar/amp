command :serve do |c|
  ...
  c.opt :path,    "The path section of the URL (e.g. /repository/served/)",    :short => "-P", :type => :string, :default => "/"
  ...
  c.opt :storage, "Store the users in [TYPE] manner. Can be 'memory'", :short => "-s", :type => :string,
                                                                               :default => 'memory'
